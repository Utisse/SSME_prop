...
Ns = Dp/Dp_ps ; % numero di stadi necessari alla pompa -> se <1 Ns = 1
Dh = Pp/mdot ; % salto entalpico
Dt = Dh/cp ; %variazione di temperatura-> molto meno importante dell'aumento della pressione

% Q->volumetric mass flow rate -> Q = mdot/rho ;
% Vs -> stage specific speed [rpm] -> inizializza a un numero e poi
% rivaluta
